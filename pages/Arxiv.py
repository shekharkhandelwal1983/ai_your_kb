...
st.title("Add Arxiv Research Paper Content")
...
arxiv_id = st.text_input("Arxiv ID:", type="default", key="arxiv_id")
...
if submit:
    ...
    st.success(f"Added {docs[0].metadata['Title']} to knowledge base: {selected_collection}")
