...
url = st.text_input("Website url:", type="default", key="url")
recursive = st.checkbox('Recursive Loading')
...
if url:
    ...
    if submit:
        docs = loader.load()
        st.write(f"Total web pages scraped: {len(docs)}")
